...
{
    vel_cmd_ = airsim_ros_pkgs_sa::VelCmd();
    // ROS params
    ...
    // ROS publishers
    airsim_vel_cmd_world_frame_pub_ = nh_private_.advertise<airsim_ros_pkgs_sa::VelCmd>("/airsim_node/" + vehicle_name + "/vel_cmd_world_frame", 1);
...
bool PIDPositionController::local_position_goal_srv_cb(airsim_ros_pkgs_sa::SetLocalPosition::Request& request, airsim_ros_pkgs_sa::SetLocalPosition::Response& response)
{
...
bool PIDPositionController::local_position_goal_srv_override_cb(airsim_ros_pkgs_sa::SetLocalPosition::Request& request, airsim_ros_pkgs_sa::SetLocalPosition::Response& response)
{
    // this tells the update timer callback to not do active hovering
    if (!got_goal_once_)
        got_goal_once_ = true;
...
void PIDPositionController::home_geopoint_cb(const airsim_ros_pkgs_sa::GPSYaw& gps_msg)
{
    if (has_home_geo_)
        return;
...
bool PIDPositionController::gps_goal_srv_cb(airsim_ros_pkgs_sa::SetGPSPosition::Request& request, airsim_ros_pkgs_sa::SetGPSPosition::Response& response)
{
    response.success = false;
...
// todo do relative altitude, or add an option for the same?
bool PIDPositionController::gps_goal_srv_override_cb(airsim_ros_pkgs_sa::SetGPSPosition::Request& request, airsim_ros_pkgs_sa::SetGPSPosition::Response& response)
{
    response.success = false;
