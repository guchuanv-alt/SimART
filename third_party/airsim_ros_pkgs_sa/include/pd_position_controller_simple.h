...
#include <airsim_ros_pkgs_sa/SetLocalPosition.h>
#include <airsim_ros_pkgs_sa/SetGPSPosition.h>
...
public:
    ...
    bool local_position_goal_srv_cb(airsim_ros_pkgs_sa::SetLocalPosition::Request& request, airsim_ros_pkgs_sa::SetLocalPosition::Response& response);
    bool local_position_goal_srv_override_cb(airsim_ros_pkgs_sa::SetLocalPosition::Request& request, airsim_ros_pkgs_sa::SetLocalPosition::Response& response);
    bool gps_goal_srv_cb(airsim_ros_pkgs_sa::SetGPSPosition::Request& request, airsim_ros_pkgs_sa::SetGPSPosition::Response& response);
    bool gps_goal_srv_override_cb(airsim_ros_pkgs_sa::SetGPSPosition::Request& request, airsim_ros_pkgs_sa::SetGPSPosition::Response& response);

    // ROS subscriber callbacks
    void airsim_odom_cb(const nav_msgs::Odometry& odom_msg);
    void home_geopoint_cb(const airsim_ros_pkgs_sa::GPSYaw& gps_msg);
...
private:
    ...
    bool has_home_geo_;
    airsim_ros_pkgs_sa::GPSYaw gps_home_msg_;

    nav_msgs::Odometry curr_odom_;
    airsim_ros_pkgs_sa::VelCmd vel_cmd_;
    bool reached_goal_;
    bool has_goal_;
    bool has_odom_;
    bool got_goal_once_;
